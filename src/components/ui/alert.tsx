...
const variantConfig = {
  success: {
    containerClass: 'bg-green-950/60 border border-green-900/60',
  ...
  error: {
    containerClass: 'bg-red-950/60 border border-red-900/60',
  ...
  info: {
    containerClass: 'bg-brand-950/60 border border-brand-900/60',
...
function Alert({ variant, message, button }: AlertProps) {
  ...
  return (
    <div className={clsx(containerClass, 'flex items-center gap-3 p-4.5 rounded-xl')} role="alert">
